...
var exists = function(fname, lname, email, role, db, res, finish) {
...
router.post('/', function(req, res) {
  ...
  if(fname && lname && email && pass && role && (role == 'student' || role == 'teacher' || role == 'assistant')) {
    exists(fname, lname, email, role, 'students', res, function() {
      exists(fname, lname, email, role, 'teachers', res, function() {
        exists(fname, lname, email, role, 'assistants', res, function() {
